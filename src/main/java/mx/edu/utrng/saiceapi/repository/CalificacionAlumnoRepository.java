...
public interface CalificacionAlumnoRepository extends CrudRepository<CalificacionAlumno, Integer> {
	// public final static String consulta_calificaciones ="SELECT cal FROM CalificacionAlumno cal WHERE  cal.valida = true AND cal.cveAlumno=:cveAlumno AND cal.cveUniversidad = :cveUniversidad";
	...
	public List<CalificacionAlumno> findByCveAlumnoAndCveUniversidad(int cveUniversidad,int cveAlumno);	
